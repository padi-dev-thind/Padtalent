...
@Service({ global: true })
class Memory_questionsRepository
  extends BaseRepository<Memory_questions>
  implements Memory_questionsRepositoryInterface<Memory_questions>
{
  constructor(
    @ModelContainer(Memory_questions.tableName)
    Memory_questions: ModelCtor<Memory_questions>,
  ) {
